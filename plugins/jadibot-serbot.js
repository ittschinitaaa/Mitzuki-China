            ...
            if (connection == `open`) {
                ...
                if (m && conn && isCode && commandFlags[m.sender]) {
                    try {
                        ...
                        // 📌 Número del sub-bot
                        let subBotNum = sock.authState.creds.me.id.split('@')[0]

                        // 📌 Mensaje con link wa.me
                        let chtxt = ` ֯　ׅ🫗ֶ֟ㅤ *Usuario ›* ${userName}

 🎋 *Método de conexión ›* ${method}
 🌱 *Browser ›* Firefox (Windows)
 🍁 *WhatsApp ›* ${waType}
 🌾 *Visita ›* wa.me/${subBotNum}?text=#code
 🌿 *Bot ›* ${wm}
 🥗 *Versión del bot ›* ^0.0.9
...
// ... (el resto de tu código sigue igual, sleep, msToTime, joinChannels, etc.)

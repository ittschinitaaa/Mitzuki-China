...
let handler = async (m, { conn, args, usedPrefix }) => { 
  try {
    ...
    let now = new Date()
    let colombianTime = new Date(now.toLocaleString('en-US', { timeZone: 'América/BuenosAires' }))
    ...
    let tiempo2 = moment.tz('América/BuenosAires').format('hh:mm A')
...
const jam = moment.tz('América/BuenosAires').locale('id').format('HH:mm:ss')
